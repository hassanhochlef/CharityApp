...
public class AddEventController implements Initializable {
    ...
    @FXML
    private JFXTextField participantInput;
    @FXML
    ...
    private void addEventActionHandler(ActionEvent event) {
        ...
        if (categInput.getSelectionModel() == null ||causeInput.getText().isEmpty() || participantInput.getText().isEmpty() || dateInput.getValue() == null)
        {
    ...
    private void updateEventActionHandler(ActionEvent event) {
        if(eventTable.getSelectionModel().getSelectedItem() == null) {
            ...
            participantInput.setText(String.valueOf(e.getNum_participants()));
    ...
    private void confirmUpdateActionHandler(ActionEvent event) {
        ...
        e1.setCause(cause);
        e1.setNum_participants(nbreParticipants);
